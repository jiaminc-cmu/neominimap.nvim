...
## [4.0.0](https://github.com/jiaminc-cmu/neominimap.nvim/compare/v3.15.3...v4.0.0) (2026-02-06)
...
* Add customized handler API ([d625b2c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d625b2c3f641b8eb963544e572576c8eaeb99259))
* Add option to close if minimap is the last window ([142f99f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/142f99f7478186aef5c722116edde429ec107e7d))
* Add option to close if minimap is the last window ([37107fe](https://github.com/jiaminc-cmu/neominimap.nvim/commit/37107fedc51611edcdf6fe41e9a1adff0534be85))
* add percent-based current-line positioning ([b2e0d0c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/b2e0d0ccbaa00831c11356cddf0e6338031f1b9c))
* Add persist options to both float and split layout ([16fe4b0](https://github.com/jiaminc-cmu/neominimap.nvim/commit/16fe4b0988b8a6308e77b430dda20faf7f385f33))
* Add persist options to buffer ([f831a6f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f831a6f21f36154fb99e82cc9c5f2c4fdc174766))
* Add sign-icon in configuration ([161c9a6](https://github.com/jiaminc-cmu/neominimap.nvim/commit/161c9a6766c18e687cf960c68fd3f659f7acc2c1))
* Add tab commands ([f0c4e43](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f0c4e43db70b0950fbf46fee5964cb0a0db7066a))
* Add tab filter ([f55bee7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f55bee7fae475dee37f543679c213f590a85f1e4))
* Add tab filter ([898614d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/898614d24d1160195645ee36d778f79540914b36))
* Allow to fix minimap width ([3030e8d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3030e8d2a3ec5f189290c54f137f9dd61af51d39))
* Allow to fix minimap width ([ff71476](https://github.com/jiaminc-cmu/neominimap.nvim/commit/ff71476f1c954b0e7379e12dc7e1aac3ed130f9f))
* Apply async tree parsing for neovim 0.11 ([abffb9f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/abffb9f68e17d686d3a1314294e0fea203cf5362))
* Autocmds to trigger search update ([93fc883](https://github.com/jiaminc-cmu/neominimap.nvim/commit/93fc883c14c8f6384a4fa054b64ff1397d170a33))
* Autocmds to trigger search update ([694447a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/694447a5bac5ac3307121c5b9ee92e3d24439916))
* Better handler api ([41c6108](https://github.com/jiaminc-cmu/neominimap.nvim/commit/41c61081e48381e781c369fcd9c4283e7f6b3415))
* Change winopt and bufopt configuration ([d90ff24](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d90ff2427df956d3bf7619499124ff004603518f))
* **config:** Changed type and meaning of bufopt and winopt ([6174718](https://github.com/jiaminc-cmu/neominimap.nvim/commit/617471857067c953a8aa354131a846a176ad363c))
* Handle cases when minimap window is invalid ([0e3c4b0](https://github.com/jiaminc-cmu/neominimap.nvim/commit/0e3c4b0427c807bee0cb83377a535255b01b593a))
* Ignore bigfile when snacks.bigfile is enabled ([cf240d0](https://github.com/jiaminc-cmu/neominimap.nvim/commit/cf240d03514c6100ed8c1d3b4d2a698a207bc978))
* Implement mark handler ([e24b1f5](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e24b1f50238e696b21838809adaf7ed2f0c272fb))
* Implment api for the status of minimap ([dc83e0d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/dc83e0d388c111187f2b3d4a07aedab65729be89))
* Incorrect line number for gitsigns ([1a73bdc](https://github.com/jiaminc-cmu/neominimap.nvim/commit/1a73bdc2732b6577db554becf23f5995fc7cc784))
* Introduce checkhealth ([e01164d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e01164dc8bc149941e8d20020af29d54cded6ee2))
* Introduce checkhealth ([9f2b354](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9f2b354456962f7c7d7815927facde3522b17148))
* Introduce lualine component ([24d3d7e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/24d3d7e389d3d354d9959925de353de1fb44d2de))
* Introduce search marks ([aa99135](https://github.com/jiaminc-cmu/neominimap.nvim/commit/aa9913515e9ce2a38b786045b8a93c929d7842f2))
* Introduce split layout in configuration ([6dcb593](https://github.com/jiaminc-cmu/neominimap.nvim/commit/6dcb5939c81d93a9de8f13a75845a55295db09e4))
* Log on command teiggered ([bb0acc2](https://github.com/jiaminc-cmu/neominimap.nvim/commit/bb0acc2f8f80b483a7f91ee0895aef2c61d17835))
* More highlights in cursorline ([e15473c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e15473c3364cf634ddb709831d8701d8ca2879a8))
* More highlights in cursorline ([0f4836a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/0f4836a5ebb9d9a0ba7fc5da8bee8bad539edc9a))
* New Annotation mode: icons ([ad5eba7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/ad5eba759572e53999f8bf6129e5a4793312991a))
* New command to keep consistent with vim command style; Deprecate old command ([f86ceaf](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f86ceaf1a2d6f9da1180cf0f6da4bd2d2f43339d))
* New lua api ([168a6d8](https://github.com/jiaminc-cmu/neominimap.nvim/commit/168a6d8176ae541d6de402bc71f83afef34728f2))
* Remove statuscolumn in defaut winopt ([3dcfb53](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3dcfb53f6e1e139ba127805a8890d482968662d6))
* Set neominimap filetype ([6e32314](https://github.com/jiaminc-cmu/neominimap.nvim/commit/6e32314c63118ce2142a8cc01507ee52781af8b3))
* Set neominimap filetype ([309deb2](https://github.com/jiaminc-cmu/neominimap.nvim/commit/309deb2842158edc68c30671b291627cf7875cd4))
* small optimization on annotations with folds ([f4c3c7b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f4c3c7b5d6ed842479a22dd9375fe8c19b1be2ef))
* Split window prototype ([1beff18](https://github.com/jiaminc-cmu/neominimap.nvim/commit/1beff183e5e8779845dbec4dd11dce1c4f1dbf59))
* Support mini-diff ([5e984da](https://github.com/jiaminc-cmu/neominimap.nvim/commit/5e984da911c73ce7482ffe2287aeeb4c827faa28))
* Support mini-diff ([f3cb8bf](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f3cb8bff7a731883942e6b2e593d1c81c4707cbc))
* Support mouse click ([82891a3](https://github.com/jiaminc-cmu/neominimap.nvim/commit/82891a387ece19cac2ecb75dd9788ff97e651a73))
* Support mouse click ([f86bb95](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f86bb95dc6f897e8e1382537c8681343cec85946))
* Support split direction ([f556612](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f55661258620b4f6bc6146f2dd21fbc52af192ba))
* Support split direction ([f27f3f5](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f27f3f5cd87e3e78bb93f41c2c7097976a1c091d))
* Support split layout for botright, rightbelow, topleft and aboveleft ([f2bd8f3](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f2bd8f3827a659dcc89aeefe7b9ed60093314e06))


### Bug Fixes

* Add permissions to workflow ([29d52ce](https://github.com/jiaminc-cmu/neominimap.nvim/commit/29d52ce9e0d6a650b1e89db605fc4be1b88d2f50))
* Add winfixwidth to window options ([2ee1495](https://github.com/jiaminc-cmu/neominimap.nvim/commit/2ee1495a4276e7cef8c8110dd2d482ef6bbafbdc))
* Assign single variable instead of table ([e86815a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e86815a37b83bdb1edf43ccfc95683ddf68b6ded))
* Breaking changes in treesitter api ([021b45d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/021b45de94934efd4e4671927e553385e3ebdaef))
* Breaking changes in treesitter api ([4314fc1](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4314fc1075282e05f5a7c371a528c49ced67da4c))
* Buffer refresh do not affact cursor position ([503d8f7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/503d8f72d41b6cd8a08fb5b6f5c7b3868844e369))
* Buffer refresh do not affact cursor position ([4d3ba82](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4d3ba8244eac49ca41708d752ebb93534f1e76aa))
* Capability for older neovim version ([9de43e4](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9de43e4c118066257db7a52e3aa32aadabaed666))
* check if source window is valid ([d4d82d8](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d4d82d8d7bb0435481102703cad70fd36d610623))
* Check minimap width on refreshing ([3f36e7a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3f36e7a5bb086c1b24b38d342329ab98e864f3ca))
* Correct is_minimap_buffer function with function call instead of table look up ([1d4a8f7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/1d4a8f79fd3cd9c040b99322bedd4b8eb2856b07))
* Correct lua API ([fb8a84c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/fb8a84cebffe4f6e667812c37101f78711274e6d))
* Correct module name ([5e8cc1f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/5e8cc1faeeddc92c67fd7cc008a1b522e859c6fd))
* Correct row of annotations when foldings exist ([565f0c6](https://github.com/jiaminc-cmu/neominimap.nvim/commit/565f0c696a0f559b057775b04b4375d75418733c))
* Disable winbar for lualine ([c3f3fd2](https://github.com/jiaminc-cmu/neominimap.nvim/commit/c3f3fd2abe33e447c35e9857319f7f0afcfa6754))
* Display minimap on start screen when layout is split ([1e36e8d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/1e36e8d2856807cf010fd8a1ce521b6c03caa704))
* Display minimap on start screen when layout is split ([691a251](https://github.com/jiaminc-cmu/neominimap.nvim/commit/691a251130782640251944d7971826799b87c7ba))
* Do no trigger autocmd when setting win/buf opt ([8e8f498](https://github.com/jiaminc-cmu/neominimap.nvim/commit/8e8f498407ba1f75aa8b0db764bdcd9f8d2b797f))
* do not show eol characters ([e4f5b76](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e4f5b76da78d7d9914faf8d0353a9e7cbba26659))
* do not show eol characters ([85b2b5d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/85b2b5d2b2321282d7daf33c02c633758c9f4439))
* Errors when windows or buffers are nil or not valid ([695c3b4](https://github.com/jiaminc-cmu/neominimap.nvim/commit/695c3b42b2066587d087cb9430f120f7ce529188))
* fix-178 ([b5872fb](https://github.com/jiaminc-cmu/neominimap.nvim/commit/b5872fb410a26d32a1ecad8b28690283afc31799))
* fix-178 ([e490be9](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e490be90776cede01868634142f4eab1b0ba32c8))
* Focus not working ([6e0e531](https://github.com/jiaminc-cmu/neominimap.nvim/commit/6e0e531b4aaba03ba9596096a9b8cbaa43f64001))
* Get buffer safely in git plugins ([4e602c4](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4e602c49f7f29bb4300f0b23c4ecf9edfa994400))
* Global on/off should overrite win on/off ([a111fa8](https://github.com/jiaminc-cmu/neominimap.nvim/commit/a111fa87161719de5c940b04d98db3eab641c183))
* Handle cases when annotation range starting or ending are hidden in folds ([9d59016](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9d59016c99e6ebcac16ddf58f145ae0fd0ee6473))
* Handle cases when annotation range starting or ending are hidden… ([358a642](https://github.com/jiaminc-cmu/neominimap.nvim/commit/358a6428d947f39e23aa3eae6773c6cc5ea84011))
* Handle cases when bufnr in debounce function may be null ([47f7f6e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/47f7f6efb3b3caa5d1cf4fedb171d7ae2957c150))
* Handle cases when bufnr may be null ([a35a9d3](https://github.com/jiaminc-cmu/neominimap.nvim/commit/a35a9d3566e315dc9854e0a9e55e84931a7be0b1))
* Handle cases when hl.fg is nil ([c931780](https://github.com/jiaminc-cmu/neominimap.nvim/commit/c931780391fbc7da6019db7ef0bcd38b1d9507ca))
* Handle cases when no buffer left ([d2c7a4f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d2c7a4fee5bd6702dca68d83192f9a80d22fad5f))
* Handle cases when source window is nil ([e4849ca](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e4849ca78966d978f2ed825a497cb3d787f9f70f))
* Handle cases when str is binary ([b545a37](https://github.com/jiaminc-cmu/neominimap.nvim/commit/b545a371eb15898775d232942dde63fe5fb03a3f))
* Handle cases when str is binary ([79a7d6b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/79a7d6bafb6da25015bd66c2cfa193e8561e493e))
* Handle tab on/off in float loyout ([40ebb6c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/40ebb6c2b94581a95d1ad4a5696569a3cc2bd8ec))
* Handle WinEnter events ([47ce35e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/47ce35e9189fcb4b0163d9c044709eecaf599aa0))
* Highlight of injected languages should have higher priority ([9dc7424](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9dc7424bddcee9b727308db227e2287a4d31b295))
* Highlight of injected languages should have higher priority ([3c8d9d8](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3c8d9d8790fc4b1f9e64e378d23c8d813cbaf63a))
* Incorrect function name ([53b90e1](https://github.com/jiaminc-cmu/neominimap.nvim/commit/53b90e15aa8dd6429d0dce20fbf58fbd7f1ee734))
* Incorrect function name ([07bea09](https://github.com/jiaminc-cmu/neominimap.nvim/commit/07bea09c63974e2f49c0f629a0e029544d7fa0b5))
* Incorrect highlights ([10a033e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/10a033e5e2c33bb562748c1b0fa435f6fe954399))
* Incorrect line number of search decorators ([a7aaf0a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/a7aaf0ad30e204838cd649f45447514f5bfbe282))
* Incorrect mark lineNr ([3a23307](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3a23307d0bd1519cd5ac95e60630b970e7af186f))
* make eob character unseen in neominimap ([64e251e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/64e251e11eaf9e4322aaecbf243f92728f25db79))
* make eob character unseen in neominimap ([f3e9c52](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f3e9c52bd6844efdd76f475e8cfd08e02ac18095))
* minimap jump to the end of buffer on source buffer change ([f27a2d2](https://github.com/jiaminc-cmu/neominimap.nvim/commit/f27a2d27c9b6464de98d70d04191bafdd5308a89))
* minimap jump to the end of buffer on source buffer change ([62ddce5](https://github.com/jiaminc-cmu/neominimap.nvim/commit/62ddce5bc8483088b86b4a972b837c9fe8fa7bdc))
* Minimap not showing up for start page ([95e9a1e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/95e9a1e839dd9311c4ae4a9f788fe52dd0c2784a))
* Minimap not showing up for start page ([6102528](https://github.com/jiaminc-cmu/neominimap.nvim/commit/6102528eb54598a86de6c934447de03af1ab56b9))
* neominimap boundary line issue ([0d7d546](https://github.com/jiaminc-cmu/neominimap.nvim/commit/0d7d54696de301808fc92dc94d33dce047b4525b))
* neominimap boundary line issue ([42e9e73](https://github.com/jiaminc-cmu/neominimap.nvim/commit/42e9e738827083a1052b18f6c026234a9eea774f))
* notification level should be info ([c9d5377](https://github.com/jiaminc-cmu/neominimap.nvim/commit/c9d53773cb0ae8be92f8016db9ccd39cf5a1a0fc))
* NPE in line index ([42b8b63](https://github.com/jiaminc-cmu/neominimap.nvim/commit/42b8b63838b016db87c60192dd3a5610603fc292))
* Only show diagnostic from one source ([3d54bb6](https://github.com/jiaminc-cmu/neominimap.nvim/commit/3d54bb6d61d71db2d29ec75f77f8e774fe7f32c7))
* Only show diagnostic from one source ([ee8978b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/ee8978bc9abd8e5334941312590c0651c99fd624))
* Quit when only floating windows exist ([48fd94f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/48fd94f964684b1f42cd909032c8045e5fa48a89))
* Quit when only floating windows exist ([11ec72a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/11ec72a1bd56694eda41c94f21220e8db89c2e14))
* Reduce unnecessary win_set_buf ([442b7d1](https://github.com/jiaminc-cmu/neominimap.nvim/commit/442b7d13e03378796cb4050f1ec30bd72894e3e2))
* Safe set diagnostic info ([766932f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/766932f686923f828d347d73a6e2d6fa6ef5386f))
* Safely warp set_current_line_by_percentage ([9a40328](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9a40328226f01842770f09e1cb48bc092e006a38))
* Scrolloff overwritten when buffer is set ([093e0ad](https://github.com/jiaminc-cmu/neominimap.nvim/commit/093e0ade1d8a812f92870a07126b98d5bf17989f))
* Scrolloff overwritten when buffer is set ([dc576af](https://github.com/jiaminc-cmu/neominimap.nvim/commit/dc576afed82d7f2bd9e961dbfee36a1bc29df195))
* **search:** respect "search" in "foldopen" ([9592afc](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9592afc46b672647e9ea5e7d4b0dc37f8922be86))
* **search:** respect "search" in "foldopen" ([d283dd7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d283dd73d67cab8f2a4526e5b5b8fea06daba35f))
* Set buffer unmodifiable ([775667d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/775667d4a5b6c8c50709c91ed2c5ecdb26f5e5dd))
* Set cursor line safely ([4a2b09d](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4a2b09d4cf62e10b59d077eec2e4a11be95b71c0))
* Set parent to nil when appropriate ([be81003](https://github.com/jiaminc-cmu/neominimap.nvim/commit/be81003ab8b1784de6960db475a74158493e41c9))
* **treesitter:** Clear highlight cache when colorscheme changes ([0c0c096](https://github.com/jiaminc-cmu/neominimap.nvim/commit/0c0c096a13d0f9352cae749cdc8496292c2b560d))
* ts_util not available on main branch of treesitter ([8eafa33](https://github.com/jiaminc-cmu/neominimap.nvim/commit/8eafa334a91125fb3b72e33a7e675962fa6c4047))
* ts_util not available on main branch of treesitter ([c7a797f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/c7a797fbe2d5e099f421bce79fa7172cb8db15ba))
* Type check ([d8913b4](https://github.com/jiaminc-cmu/neominimap.nvim/commit/d8913b412ecc9bc91c31ed2997395eecea652d8e))
* typo ([b97048e](https://github.com/jiaminc-cmu/neominimap.nvim/commit/b97048ed09e4286dd4ca2ed8f02cf78c910ccc3b))
* Update cursor line when minimap text changed ([c219bf3](https://github.com/jiaminc-cmu/neominimap.nvim/commit/c219bf37b5bea802c3bf00d2ac0ba80763dc2ffe))
* Update cursor line when minimap text changed ([af8d138](https://github.com/jiaminc-cmu/neominimap.nvim/commit/af8d13891319b55e2b8b8ee30be6124244835a9c))
* use a valid module to call ([b73ccc7](https://github.com/jiaminc-cmu/neominimap.nvim/commit/b73ccc7b10594b6b4ae81c648dad5a3950f5dbeb))
* use a valid module to call ([8915160](https://github.com/jiaminc-cmu/neominimap.nvim/commit/8915160791ae6a165bbffc8d92b89976bf1d349e))
* Use correct group for user events ([90da838](https://github.com/jiaminc-cmu/neominimap.nvim/commit/90da838c631882a3080bd267e45b0eadd6d61dee))
* Use correct group for user events ([8bacc1b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/8bacc1bd3d1b2090071b4759ef9c2c99a1c8e303))
* Use pcall in noautocmd ([1ebe37f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/1ebe37f754bdd0df6589b86a251cc27008cda21e))
* Use pcall to safely load external dependencies ([2be105c](https://github.com/jiaminc-cmu/neominimap.nvim/commit/2be105c74d0a2576de49a70eddff5a32cf6f0ede))
* Use pcall to safely load external dependencies ([632ebf0](https://github.com/jiaminc-cmu/neominimap.nvim/commit/632ebf0bc5f07ecc54ce02b52f70733892f20f2a))
* Use secrets.GITHUB_TOKEN ([233d05f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/233d05f4c0663805c1dcf7afa006f176e0a46d55))
* Validate config.split.close_if_last_window ([4f33e39](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4f33e39c172028e76954f98ac42a3ae983d2fc25))


### Performance Improvements

* Better log ([851ec1b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/851ec1bfef29240d6d1b29044249ff207da3ea03))
* Better log ([e56ae38](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e56ae3804a1bebacc0fe91031455dd87b37f8779))
* Do not load unnucessary window handler ([e6043ea](https://github.com/jiaminc-cmu/neominimap.nvim/commit/e6043eae48b32e18094aba67265f15ae2059891f))
* Lazy create autocmds for split window ([bf5107f](https://github.com/jiaminc-cmu/neominimap.nvim/commit/bf5107f393f1d8ed943161753ab326da58117608))
* Lazy load commands ([4d3e56a](https://github.com/jiaminc-cmu/neominimap.nvim/commit/4d3e56a1691478a2418bcc8d0cb9c64c99433861))
* Use cooperative scheduling to make it non-blocking ([98ad591](https://github.com/jiaminc-cmu/neominimap.nvim/commit/98ad591ec10a424ecfcef061a2cb083eb6e71a27))
* Validate configuration in checkhealth ([9b21120](https://github.com/jiaminc-cmu/neominimap.nvim/commit/9b21120fae860f1ec22ae9ea347dd4a9a0db66ba))


### Reverts

* "Merge pull request [#212](https://github.com/jiaminc-cmu/neominimap.nvim/issues/212) from 0xFishbyte/fix-buffer-jump" ([09de58b](https://github.com/jiaminc-cmu/neominimap.nvim/commit/09de58bc6b62abfe7c679093139b6e669003508c))
